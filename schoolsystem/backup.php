...
$selectedSchoolYearEnd = '';
$selectedTerm = '';
$students = [];
$offerings = [];

if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['schoolLevel'], $_POST['schoolYearStart'], $_POST['schoolYearEnd'], $_POST['term'])) {
    $selectedSchoolLevel = $_POST['schoolLevel'];
    $selectedSchoolYearStart = $_POST['schoolYearStart'];
    $selectedSchoolYearEnd = $_POST['schoolYearEnd'];
    $selectedTerm = $_POST['term'];
    $selectedSchoolYear = $selectedSchoolYearStart . '-' . $selectedSchoolYearEnd;
    ...
    <div class="teacher-content">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="schoolYearStart" required placeholder="YYYY" style="width: 60px;" value="<?php echo $selectedSchoolYearStart; ?>">
                -
                <input type="text" name="schoolYearEnd" required placeholder="YYYY" style="width: 60px;" value="<?php echo $selectedSchoolYearEnd; ?>">
            </div>
            <div class="form-group">
                <label for="term">Term:</label>
                <input type="text" name="term" id="term" required placeholder="e.g., Fall" value="<?php echo $selectedTerm; ?>">
            </div>
